...
Artifact components need two schemas: `summaryProps` and `fullProps`.

### Summary props

For the summary view (what users see in lists):
...
```json
{
  ...
  "properties": {
    "title": {
      "type": "string",
      "description": "Brief title for the artifact"
    },
    "status": {
      "type": "string",
...
For the detailed view (what users see when they open the artifact):
...
```json
{
  ...
  "properties": {
    "title": {
      "type": "string",
      "description": "Full title of the artifact"
    },
    "content": {
      "type": "string",
