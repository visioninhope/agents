...
<Note>To delete an agent, click on the agent box and then hit the backspace key.</Note>
...
<Note>To delete a tool, click on the tool box and then hit the backspace key.</Note>
