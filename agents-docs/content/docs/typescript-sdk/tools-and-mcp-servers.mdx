...
MCP tools can be configured with credentials to access external services. See [Credentials](/typescript-sdk/credential-store) for how to store and retrieve credentials.
