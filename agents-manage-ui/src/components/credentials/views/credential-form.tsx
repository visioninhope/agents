	...
	useEffect(() => {
		const loadAvailableTools = async () => {
			try {
				...
				const toolsWithoutCredentials = allTools.filter(
					(tool) => !tool.credentialReferenceId,
				);
				...
				<div className="space-y-8">
					...
					<div className="space-y-3">
						...
						<div className="text-xs text-muted-foreground p-3 bg-muted/30 rounded-md">
							<p className="mb-2">
								<strong>How this works:</strong> When your agent connects to the
								MCP server, this API key will be automatically sent as an
