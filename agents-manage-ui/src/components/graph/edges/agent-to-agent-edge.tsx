...
export function AgentToAgentEdge({
	...
	const transferMarkerStart =
		hasTransfer && relationships.transferTargetToSource
			? getMarker(!!selected)
			: undefined;
	const transferMarkerEnd =
		hasTransfer && relationships.transferSourceToTarget
			? getMarker(!!selected)
			: undefined;

	const delegateMarkerStart =
		hasDelegate && relationships.delegateTargetToSource
			? getMarker(!!selected)
			: undefined;
	const delegateMarkerEnd =
		hasDelegate && relationships.delegateSourceToTarget
			? getMarker(!!selected)
			: undefined;
