...
import {
	type ArtifactComponentFormData,
...
const formatFormData = (
	data?: ArtifactComponentFormData,
): ArtifactComponentFormData => {
...
export function ArtifactComponentForm({
	...
	const onSubmit = async (data: ArtifactComponentFormData) => {
		try {
			...
			if (id) {
				const res = await updateArtifactComponentAction(
					tenantId,
					projectId,
					payload,
				);
				...
				const res = await createArtifactComponentAction(
					tenantId,
					projectId,
					payload,
				);
