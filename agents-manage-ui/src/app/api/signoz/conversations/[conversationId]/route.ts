      ...
      builderQueries: {
        toolCalls: listQuery(
          ...
          [
            ...
            { key: SPAN_KEYS.TIMESTAMP, ...QUERY_FIELD_CONFIGS.INT64_TAG_COLUMN },
            { key: SPAN_KEYS.HAS_ERROR, ...QUERY_FIELD_CONFIGS.BOOL_TAG_COLUMN },
            { key: SPAN_KEYS.DURATION_NANO, ...QUERY_FIELD_CONFIGS.FLOAT64_TAG_COLUMN },
            { key: SPAN_KEYS.AI_TOOL_CALL_NAME, ...QUERY_FIELD_CONFIGS.STRING_TAG },
            { key: SPAN_KEYS.AI_TOOL_CALL_RESULT, ...QUERY_FIELD_CONFIGS.STRING_TAG },
            ...
            { key: SPAN_KEYS.STATUS_MESSAGE, ...QUERY_FIELD_CONFIGS.STRING_TAG },
            { key: SPAN_KEYS.OTEL_STATUS_DESCRIPTION, ...QUERY_FIELD_CONFIGS.STRING_TAG },
        ...
        contextResolution: listQuery(
          ...
          [
            ...
            { key: SPAN_KEYS.STATUS_MESSAGE, ...QUERY_FIELD_CONFIGS.STRING_TAG },
            { key: SPAN_KEYS.OTEL_STATUS_DESCRIPTION, ...QUERY_FIELD_CONFIGS.STRING_TAG },
            { key: SPAN_KEYS.CONTEXT_CONFIG_ID, ...QUERY_FIELD_CONFIGS.STRING_TAG },
            { key: SPAN_KEYS.CONTEXT_AGENT_GRAPH_ID, ...QUERY_FIELD_CONFIGS.STRING_TAG },
            {
        ...
        userMessages: listQuery(
          ...
          [
            ...
            { key: SPAN_KEYS.MESSAGE_TIMESTAMP, ...QUERY_FIELD_CONFIGS.STRING_TAG },
            { key: SPAN_KEYS.GRAPH_ID, ...QUERY_FIELD_CONFIGS.STRING_TAG },
            { key: SPAN_KEYS.GRAPH_NAME, ...QUERY_FIELD_CONFIGS.STRING_TAG },
          ]
        ),
        ...
        aiAssistantMessages: listQuery(
          ...
          [
            {
              key: { key: SPAN_KEYS.AI_RESPONSE_CONTENT, ...QUERY_FIELD_CONFIGS.STRING_TAG },
              op: OPERATORS.NOT_EQUALS,
              value: '',
            },
          ],
          [
            ...
            { key: SPAN_KEYS.HAS_ERROR, ...QUERY_FIELD_CONFIGS.BOOL_TAG_COLUMN },
            { key: SPAN_KEYS.DURATION_NANO, ...QUERY_FIELD_CONFIGS.FLOAT64_TAG_COLUMN },
            { key: SPAN_KEYS.AI_RESPONSE_CONTENT, ...QUERY_FIELD_CONFIGS.STRING_TAG },
            { key: SPAN_KEYS.AI_RESPONSE_TIMESTAMP, ...QUERY_FIELD_CONFIGS.STRING_TAG },
            { key: SPAN_KEYS.AI_AGENT_NAME_ALT, ...QUERY_FIELD_CONFIGS.STRING_TAG },
          ]
        ),
        ...
        aiGenerations: listQuery(
          ...
          [
            ...
            { key: SPAN_KEYS.AI_TELEMETRY_FUNCTION_ID, ...QUERY_FIELD_CONFIGS.STRING_TAG },
            { key: SPAN_KEYS.AI_RESPONSE_MODEL, ...QUERY_FIELD_CONFIGS.STRING_TAG },
            { key: SPAN_KEYS.GEN_AI_USAGE_INPUT_TOKENS, ...QUERY_FIELD_CONFIGS.INT64_TAG },
            { key: SPAN_KEYS.GEN_AI_USAGE_OUTPUT_TOKENS, ...QUERY_FIELD_CONFIGS.INT64_TAG },
          ]
        ),
        ...
        aiStreamingText: listQuery(
          ...
          [
            ...
            { key: SPAN_KEYS.AI_RESPONSE_TEXT, ...QUERY_FIELD_CONFIGS.STRING_TAG },
            { key: SPAN_KEYS.AI_RESPONSE_MODEL, ...QUERY_FIELD_CONFIGS.STRING_TAG },
            { key: SPAN_KEYS.AI_MODEL_PROVIDER, ...QUERY_FIELD_CONFIGS.STRING_TAG },
            { key: SPAN_KEYS.AI_OPERATION_ID, ...QUERY_FIELD_CONFIGS.STRING_TAG },
            { key: SPAN_KEYS.GEN_AI_USAGE_INPUT_TOKENS, ...QUERY_FIELD_CONFIGS.INT64_TAG },
            { key: SPAN_KEYS.GEN_AI_USAGE_OUTPUT_TOKENS, ...QUERY_FIELD_CONFIGS.INT64_TAG },
          ]
        ),
        ...
        contextFetchers: listQuery(
          ...
          [
            ...
            { key: SPAN_KEYS.HTTP_STATUS_CODE, ...QUERY_FIELD_CONFIGS.STRING_TAG },
            { key: SPAN_KEYS.HTTP_RESPONSE_BODY_SIZE, ...QUERY_FIELD_CONFIGS.STRING_TAG },
          ]
        ),
