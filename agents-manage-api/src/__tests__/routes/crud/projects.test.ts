...
describe('Project CRUD Routes - Integration Tests', () => {
  ...
  const createTestProject = async ({
    ...
    const createRes = await makeRequest(`/tenants/${tenantId}/crud/projects`, {
      method: 'POST',
  ...
  describe('GET /', () => {
    it('should list projects with pagination (empty initially)', async () => {
      ...
      const res = await app.request(`/tenants/${tenantId}/crud/projects?page=1&limit=10`);
    ...
    it('should handle pagination with multiple pages', async () => {
      ...
      const page1Res = await app.request(`/tenants/${tenantId}/crud/projects?page=1&limit=2`);
      ...
      // Test second page
      const page2Res = await app.request(`/tenants/${tenantId}/crud/projects?page=2&limit=2`);
      ...
      const page3Res = await app.request(`/tenants/${tenantId}/crud/projects?page=3&limit=2`);
    ...
    it('should return empty data for page beyond available data', async () => {
      ...
      const res = await app.request(`/tenants/${tenantId}/crud/projects?page=5&limit=2`);
      expect(res.status).toBe(200);
    ...
    it('should enforce max limit of 100', async () => {
      ...
      const res = await app.request(`/tenants/${tenantId}/crud/projects?page=1&limit=200`);
      ...
      if (res.status === 400) {
        ...
        const res2 = await app.request(`/tenants/${tenantId}/crud/projects?page=1&limit=100`);
    ...
    it('should handle default pagination parameters', async () => {
      ...
      const res = await app.request(`/tenants/${tenantId}/crud/projects`);
      expect(res.status).toBe(200);
  ...
  describe('GET /{id}', () => {
    it('should get a single project by ID', async () => {
      ...
      const res = await app.request(`/tenants/${tenantId}/crud/projects/${projectId}`);
      expect(res.status).toBe(200);
    ...
    it('should return 404 for non-existent project', async () => {
      ...
      const res = await app.request(`/tenants/${tenantId}/crud/projects/non-existent-id`);
    ...
    it('should not return projects from other tenants', async () => {
      ...
      const res = await app.request(`/tenants/${tenantId2}/crud/projects/${projectId}`);
      expect(res.status).toBe(404);
    });
  });
  ...
  describe('POST /', () => {
    it('should create a new project', async () => {
      ...
      const res = await makeRequest(`/tenants/${tenantId}/crud/projects`, {
        method: 'POST',
        body: JSON.stringify(projectData),
      });
      ...
      const getRes = await app.request(`/tenants/${tenantId}/crud/projects/${projectData.id}`);
    ...
    it('should return 409 when creating a project with duplicate ID', async () => {
      ...
      const res1 = await makeRequest(`/tenants/${tenantId}/crud/projects`, {
        method: 'POST',
        body: JSON.stringify(projectData),
      });
      ...
      const res2 = await makeRequest(`/tenants/${tenantId}/crud/projects`, {
        method: 'POST',
        body: JSON.stringify(projectData),
      });
    ...
    it('should validate required fields', async () => {
      ...
      // Missing id
      const res3 = await makeRequest(`/tenants/${tenantId}/crud/projects`, {
        method: 'POST',
        body: JSON.stringify({
          name: 'Test name',
          description: 'Test description',
  ...
  describe('PATCH /{id}', () => {
    ...
    it('should allow partial updates', async () => {
      ...
      // Update only name
      const res1 = await makeRequest(`/tenants/${tenantId}/crud/projects/${projectId}`, {
        method: 'PATCH',
      ...
      const res2 = await makeRequest(`/tenants/${tenantId}/crud/projects/${projectId}`, {
        method: 'PATCH',
    ...
    it('should return 404 for non-existent project', async () => {
      ...
      const res = await makeRequest(`/tenants/${tenantId}/crud/projects/non-existent-id`, {
        method: 'PATCH',
    ...
    it('should not update projects from other tenants', async () => {
      ...
      const res = await makeRequest(`/tenants/${tenantId2}/crud/projects/${projectId}`, {
        method: 'PATCH',
  ...
  describe('DELETE /{id}', () => {
    ...
    it('should not delete projects from other tenants', async () => {
      ...
      const getRes = await app.request(`/tenants/${tenantId1}/crud/projects/${projectId}`);
      expect(getRes.status).toBe(200);
    });
  });
  ...
  describe('Complex scenarios', () => {
    it('should handle concurrent operations correctly', async () => {
      ...
      // Verify count
      const listRes = await app.request(`/tenants/${tenantId}/crud/projects?limit=10`);
    ...
    it('should maintain data isolation between tenants', async () => {
      ...
      const res1 = await app.request(`/tenants/${tenantId1}/crud/projects?limit=10`);
      const body1 = await res1.json();
      expect(body1.data).toHaveLength(3);

      const res2 = await app.request(`/tenants/${tenantId2}/crud/projects?limit=10`);
      const body2 = await res2.json();
