 ...
 */
const tryWellKnownEndpoints = async (baseUrl: string): Promise<OAuthConfig | null> => {
 ...
 */
const checkForOAuthEndpoints = async (serverUrl: string): Promise<boolean> => {
 ...
 */
export const discoverOAuthEndpoints = async (serverUrl: string): Promise<OAuthConfig | null> => {
  try {
